...
public class Checkers {
    ...
    public static class CheckersBuldier {
        private Board board = new Board();
        private String playerOne = "";
        private String playerTwo = "";

        public CheckersBuldier PlayerOne(String playerOne) {
            this.playerOne = playerOne;
            return this;
        }

        public CheckersBuldier PlayerTwo(String playerTwo) {
            this.playerTwo = playerTwo;
            return this;
        }

        public CheckersBuldier Figure(String figureType, String figureColor, int x, int y) {
