...
public class ForumTestSuit {
    ...
    public void testAddPost() {
        ...
        forumUser.addPost("mrsmih", "Hello everyone, this is my first contribution here!");
    ...
    public void testAddComment() {
        ...
        forumUser.addComment(thePost, "String author", "mrsmith");
    ...
    public void testRemoveComment() {
        ForumUser forumUser = new ForumUser("mrsmith", "Jon Smith");
        ForumPost thePost = new ForumPost("Hello everyone" + "this is my first contribution here!",
                "mrsmith");
        ForumComment theComment = new ForumComment(thePost, "mrsmith", "Thank you for all good words!");
